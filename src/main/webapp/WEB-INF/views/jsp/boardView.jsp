...
$(function(){
	...
	$.ajax({method:"get",url:"/exam/board/selectOne",data:{boardNo:boardNo}})
	.done(function(data){
	...
	$("#load").on("click",function(){
		location.href="/exam/move/boardUpdate?boardMenu="+boardMenu+"&boardNo="+boardNo
	});
	$("#del").on("click",function(){
		var del = confirm("정말 삭제하시겠습니까?");
		if(del){			
			alert("삭제하였습니다");
			location.href="/exam/board/delete?boardMenu="+boardMenu+"&page=0&boardNo="+boardNo;
		}
	});
	$("#back").on("click",function(){
		//location.href="/exam/board/selectList&boardMenu="+boardMenu+"&page=0";
		location.href="/exam/board/selectList?boardMenu="+boardMenu+"&page=0";
	});
});
</script>
