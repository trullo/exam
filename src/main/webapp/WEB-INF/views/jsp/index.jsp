...
<body>
    ...
    <div id="div0">
        <img id="img_div0" src="http://localhost:8080/exam/img/big-logo.png">
    ...
    <div id="div_main">
        ...
        <div id="div4">
                <img class="mySlides" src="http://localhost:8080/exam/img/7.jpg" style="width: 100%; display: block;">
                <img class="mySlides" src="http://localhost:8080/exam/img/2.jpg" style="width: 100%; display: none;">
                <img class="mySlides" src="http://localhost:8080/exam/img/3.jpg" style="width: 100%; display: none;">
                <img class="mySlides" src="http://localhost:8080/exam/img/4.jpg" style="width: 100%; display: none;">
                <img class="mySlides" src="http://localhost:8080/exam/img/5.jpg" style="width: 100%; display: none;">
                <img class="mySlides" src="http://localhost:8080/exam/img/6.jpg" style="width: 100%; display: none;">
                <img class="mySlides" src="http://localhost:8080/exam/img/1.jpg" style="width: 100%; display: none;">
                <div id="div4_1">
